...
## CodeSystem: BRUnidadeTempo 

| | |
| :--- | :--- |
| *URL Canônica*:https://terminologia.saude.gov.br/fhir/CodeSystem/BRUnidadeTempo | *Versão*:1.1.0 |
| Active as of 2026-08-31 | *Nome computável*:BRUnidadeTempo |
...
```json
{
  ...
  "id" : "BRUnidadeTempo",
  "meta" : {
    "lastUpdated" : "2026-07-24T16:03:11.689Z"
  },
  "extension" : [{
    "url" : "http://fhir.org/FHIRsmith/StructureDefinition/ocl-codesystem",
    "valueBoolean" : true
  }],
  "url" : "https://terminologia.saude.gov.br/fhir/CodeSystem/BRUnidadeTempo",
  "version" : "1.1.0",
  "name" : "BRUnidadeTempo",
  "title" : "BRUnidadeTempo",
  "status" : "active",
  "experimental" : false,
