...
## CodeSystem: BRStatusAgendamentoRegulacaoAssistencial 

| | |
| :--- | :--- |
| *URL Canônica*:https://terminologia.saude.gov.br/fhir/CodeSystem/BRStatusAgendamentoRegulacaoAssistencial | *Versão*:1.1.0 |
| Active as of 2026-08-31 | *Nome computável*:BRStatusAgendamentoRegulacaoAssistencial |
...
```json
{
  ...
  "meta" : {
    "lastUpdated" : "2026-07-24T16:02:54.564Z"
  },
  "extension" : [{
    "url" : "http://fhir.org/FHIRsmith/StructureDefinition/ocl-codesystem",
    "valueBoolean" : true
  }],
  "url" : "https://terminologia.saude.gov.br/fhir/CodeSystem/BRStatusAgendamentoRegulacaoAssistencial",
  "version" : "1.1.0",
