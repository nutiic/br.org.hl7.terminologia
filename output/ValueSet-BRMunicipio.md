# BR.GOV.SAUDE.TERMINOLOGIA.FHIR\BR Municipio - FHIR v4.0.1

* [**Table of Contents**](toc.md)
* [**Lista de artefatos**](artifacts.md)
* **BR Municipio**

## ValueSet: BR Municipio 

| | |
| :--- | :--- |
| *URL Canônica*:https://terminologia.saude.gov.br/fhir/ValueSet/BRMunicipio | *Versão*:1.1.0 |
| Active as of 2026-03-09 | *Nome computável*:BRMunicipio |
...
```json
{
  ...
  "id" : "BRMunicipio",
  "url" : "https://terminologia.saude.gov.br/fhir/ValueSet/BRMunicipio",
  "version" : "1.1.0",
  "name" : "BRMunicipio",
  "title" : "BR Municipio",
  "status" : "active",
