# BR.GOV.SAUDE.TERMINOLOGIA.FHIR\BR Imunobiologico - FHIR v4.0.1

* [**Table of Contents**](toc.md)
* [**Lista de artefatos**](artifacts.md)
* **BR Imunobiologico**

## ValueSet: BR Imunobiologico 

| | |
| :--- | :--- |
| *URL Canônica*:https://terminologia.saude.gov.br/fhir/ValueSet/BRImunobiologico | *Versão*:1.1.0 |
...
```json
{
  ...
  "id" : "BRImunobiologico",
  "url" : "https://terminologia.saude.gov.br/fhir/ValueSet/BRImunobiologico",
  "version" : "1.1.0",
