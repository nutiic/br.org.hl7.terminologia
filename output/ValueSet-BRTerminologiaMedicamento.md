# BR.GOV.SAUDE.TERMINOLOGIA.FHIR\BR Terminologia Medicamento - FHIR v4.0.1

* [**Table of Contents**](toc.md)
* [**Lista de artefatos**](artifacts.md)
* **BR Terminologia Medicamento**

## ValueSet: BR Terminologia Medicamento 

| | |
| :--- | :--- |
| *URL Canônica*:https://terminologia.saude.gov.br/fhir/ValueSet/BRTerminologiaMedicamento | *Versão*:1.1.0 |
| Active as of 2026-03-09 | *Nome computável*:BRTerminologiaMedicamento |
...
```json
{
  ...
  "url" : "https://terminologia.saude.gov.br/fhir/ValueSet/BRTerminologiaMedicamento",
  "version" : "1.1.0",
  ...
  "compose" : {
    "include" : [{
      "system" : "https://terminologia.saude.gov.br/fhir/CodeSystem/BRObmCATMAT",
      "concept" : [{
        "code" : "BR0282714",
