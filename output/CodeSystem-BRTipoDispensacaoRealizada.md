...
| | |
| :--- | :--- |
| *URL Canônica*:https://terminologia.saude.gov.br/fhir/CodeSystem/BRTipoDispensacaoRealizada | *Versão*:1.1.0 |
| Active as of 2026-08-31 | *Nome computável*:BRTipoDispensacaoRealizada |
...
```json
{
  ...
  "meta" : {
    "lastUpdated" : "2026-07-24T16:03:14.513Z"
  },
  "extension" : [{
    "url" : "http://fhir.org/FHIRsmith/StructureDefinition/ocl-codesystem",
    "valueBoolean" : true
  }],
  "url" : "https://terminologia.saude.gov.br/fhir/CodeSystem/BRTipoDispensacaoRealizada",
  "version" : "1.1.0",
