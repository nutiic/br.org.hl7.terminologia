# BR.GOV.SAUDE.TERMINOLOGIA.FHIR\BR Reason Encounter - FHIR v4.0.1

* [**Table of Contents**](toc.md)
* [**Lista de artefatos**](artifacts.md)
* **BR Reason Encounter**

## ValueSet: BR Reason Encounter 

| | |
| :--- | :--- |
| *URL Canônica*:https://terminologia.saude.gov.br/fhir/ValueSet/BRReasonEncounter | *Versão*:1.1.0 |
| Active as of 2026-08-31 | *Nome computável*:BRReasonEncounter |
...
```json
{
  ...
  "id" : "BRReasonEncounter",
  "url" : "https://terminologia.saude.gov.br/fhir/ValueSet/BRReasonEncounter",
  "version" : "1.1.0",
  "name" : "BRReasonEncounter",
  "title" : "BR Reason Encounter",
  "status" : "active",
