# BR.GOV.SAUDE.TERMINOLOGIA.FHIR\BR Programa Saude - FHIR v4.0.1

* [**Table of Contents**](toc.md)
* [**Lista de artefatos**](artifacts.md)
* **BR Programa Saude**

## ValueSet: BR Programa Saude 

| | |
| :--- | :--- |
| *URL Canônica*:https://terminologia.saude.gov.br/fhir/ValueSet/BRProgramaSaude | *Versão*:1.1.0 |
...
```json
{
  ...
  "id" : "BRProgramaSaude",
  "url" : "https://terminologia.saude.gov.br/fhir/ValueSet/BRProgramaSaude",
  "version" : "1.1.0",
  ...
  "compose" : {
    "include" : [{
      "system" : "https://terminologia.saude.gov.br/fhir/CodeSystem/BRProgramaSaude",
      "concept" : [{
        "code" : "501",
