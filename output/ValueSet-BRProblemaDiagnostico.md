# BR.GOV.SAUDE.TERMINOLOGIA.FHIR\BR Problema Diagnostico - FHIR v4.0.1

* [**Table of Contents**](toc.md)
* [**Lista de artefatos**](artifacts.md)
* **BR Problema Diagnostico**

## ValueSet: BR Problema Diagnostico 

| | |
| :--- | :--- |
| *URL Canônica*:https://terminologia.saude.gov.br/fhir/ValueSet/BRProblemaDiagnostico | *Versão*:1.1.0 |
| Active as of 2026-03-09 | *Nome computável*:BRProblemaDiagnostico |
...
```json
{
  ...
  "url" : "https://terminologia.saude.gov.br/fhir/ValueSet/BRProblemaDiagnostico",
  "version" : "1.1.0",
  "name" : "BRProblemaDiagnostico",
  "title" : "BR Problema Diagnostico",
  "status" : "active",
