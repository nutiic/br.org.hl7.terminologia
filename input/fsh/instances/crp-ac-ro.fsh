...
Title: "NamingSystemCRPACRO"
Description: "CONSELHO REGIONAL DE PSICOLOGIA"
Usage: #definition
* extension[0].url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-NamingSystem.url"
* extension[=].valueUri = "https://terminologia.saude.gov.br/fhir/NamingSystem/crp-ac-ro"
...
* uniqueId.type = #uri
* uniqueId.value = "https://saude.gov.br/fhir/sid/crp-ac-ro"
