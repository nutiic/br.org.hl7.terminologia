...
Title: "NamingSystemCRESSPR"
Description: "Conselho Regional de Serviço Social 11ª Região"
Usage: #definition
* extension[0].url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-NamingSystem.url"
* extension[=].valueUri = "https://terminologia.saude.gov.br/fhir/NamingSystem/cress-pr"
...
* uniqueId.type = #uri
* uniqueId.value = "https://saude.gov.br/fhir/sid/cress-pr"
