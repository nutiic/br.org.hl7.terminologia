Instance: BRAtendimentoPrestado
...
* extension[=].valueUri = "https://terminologia.saude.gov.br/fhir/NamingSystem/BRAtendimentoPrestado"
...
* uniqueId[0].type = #uri
* uniqueId[=].value = "http://www.saude.gov.br/fhir/r4/CodeSystem/BRAtendimentoPrestado"
* uniqueId[=].preferred = false
* uniqueId[+].type = #uri
* uniqueId[=].value = "https://terminologia.saude.gov.br/fhir/CodeSystem/BRAtendimentoPrestado"
