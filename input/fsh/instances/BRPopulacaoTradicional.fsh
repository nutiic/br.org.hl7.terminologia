Instance: BRPopulacaoTradicional
InstanceOf: NamingSystem
Title: "BRPopulacaoTradicional"
Description: "Populacao Tradicional"
Usage: #definition
* language = #pt
* extension[0].url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-NamingSystem.url"
* extension[=].valueUri = "https://terminologia.saude.gov.br/fhir/NamingSystem/BRPopulacaoTradicional"
...
* uniqueId.type = #uri
* uniqueId.value = "https://terminologia.saude.gov.br/fhir/CodeSystem/BRPopulacaoTradicional"
