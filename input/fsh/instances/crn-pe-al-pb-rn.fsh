Instance: crn-pe-al-pb-rn
InstanceOf: NamingSystem
Title: "NamingSystemCRNPEALPBRN"
Description: "CONSELHO REGIONAL DE NUTRICIONISTA"
Usage: #definition
* extension[0].url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-NamingSystem.url"
* extension[=].valueUri = "https://terminologia.saude.gov.br/fhir/NamingSystem/crn-pe-al-pb-rn"
...
* uniqueId.type = #uri
* uniqueId.value = "https://saude.gov.br/fhir/sid/crn-pe-al-pb-rn"
