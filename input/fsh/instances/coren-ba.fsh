...
Title: "NamingSystemCORENBA"
Description: "CONSELHO REGIONAL DE ENFERMAGEM"
Usage: #definition
* extension[0].url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-NamingSystem.url"
* extension[=].valueUri = "https://terminologia.saude.gov.br/fhir/NamingSystem/coren-ba"
...
* uniqueId.type = #uri
* uniqueId.value = "https://saude.gov.br/fhir/sid/coren-ba"
