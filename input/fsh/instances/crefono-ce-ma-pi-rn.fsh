Instance: crefono-ce-ma-pi-rn
InstanceOf: NamingSystem
Title: "NamingSystemCREFONOCEMAPIRN"
Description: "Conselho Regional de Fonoaudiologia 8ª Região (CE, MA, PI e RN)"
Usage: #definition
* extension[0].url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-NamingSystem.url"
* extension[=].valueUri = "https://terminologia.saude.gov.br/fhir/NamingSystem/crefono-ce-ma-pi-rn"
...
* uniqueId.type = #uri
* uniqueId.value = "https://saude.gov.br/fhir/sid/crefono-ce-ma-pi-rn"
