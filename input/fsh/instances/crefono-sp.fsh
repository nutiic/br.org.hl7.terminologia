...
Title: "NamingSystemCREFONOSP"
Description: "Conselho Regional de Fonoaudiologia 2ª Região (SP)"
Usage: #definition
* extension[0].url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-NamingSystem.url"
* extension[=].valueUri = "https://terminologia.saude.gov.br/fhir/NamingSystem/crefono-sp"
...
* uniqueId.type = #uri
* uniqueId.value = "https://saude.gov.br/fhir/sid/crefono-sp"
