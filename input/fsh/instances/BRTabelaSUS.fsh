...
* extension[=].valueUri = "https://terminologia.saude.gov.br/fhir/NamingSystem/BRTabelaSUS"
...
* uniqueId[0].type = #uri
* uniqueId[=].value = "http://www.saude.gov.br/fhir/r4/CodeSystem/BRTabelaSUS"
* uniqueId[=].preferred = false
* uniqueId[+].type = #uri
* uniqueId[=].value = "https://terminologia.saude.gov.br/fhir/CodeSystem/BRTabelaSUS"
