...
Title: "NamingSystemCRNRJES"
Description: "CONSELHO REGIONAL DE NUTRICIONISTA"
Usage: #definition
* extension[0].url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-NamingSystem.url"
* extension[=].valueUri = "https://terminologia.saude.gov.br/fhir/NamingSystem/crn-rj-es"
...
* uniqueId.type = #uri
* uniqueId.value = "https://saude.gov.br/fhir/sid/crn-rj-es"
