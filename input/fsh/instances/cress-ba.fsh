...
Title: "NamingSystemCRESSBA"
Description: "Conselho Regional de Serviço Social 5ª Região"
Usage: #definition
* extension[0].url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-NamingSystem.url"
* extension[=].valueUri = "https://terminologia.saude.gov.br/fhir/NamingSystem/cress-ba"
...
* uniqueId.type = #uri
* uniqueId.value = "https://saude.gov.br/fhir/sid/cress-ba"
