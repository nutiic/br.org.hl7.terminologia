...
Title: "NamingSystemCPF"
Description: "CADASTRO DE PESSOA FÍSICA"
Usage: #definition
* extension[0].url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-NamingSystem.url"
* extension[=].valueUri = "https://terminologia.saude.gov.br/fhir/NamingSystem/cpf"
...
* uniqueId[0].type = #uri
* uniqueId[=].value = "https://saude.gov.br/fhir/sid/cpf"
* uniqueId[=].preferred = true
* uniqueId[+].type = #uri
* uniqueId[=].value = "http://rnds.saude.gov.br/fhir/r4/NamingSystem/cpf"
