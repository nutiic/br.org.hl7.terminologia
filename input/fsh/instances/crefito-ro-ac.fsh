Instance: crefito-ro-ac
InstanceOf: NamingSystem
Title: "NamingSystemCREFITOROAC"
Description: "CONSELHO REGIONAS DE FISIOTERAPIA E TERAPIA OCUPACIONAL"
Usage: #definition
* extension[0].url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-NamingSystem.url"
* extension[=].valueUri = "https://terminologia.saude.gov.br/fhir/NamingSystem/crefito-ro-ac"
...
* uniqueId.type = #uri
* uniqueId.value = "https://saude.gov.br/fhir/sid/crefito-ro-ac"
