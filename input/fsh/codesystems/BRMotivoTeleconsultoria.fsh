...
* ^content = #complete
* ^meta.lastUpdated = "2026-06-10T14:18:27.485Z"
* #apoio-conduta "Apoio à conduta terapêutica"
* #apoio-diagnostico "Apoio na hipótese diagnóstica"
* #avaliacao-encaminhamento "Avaliação da necessidade de encaminhamento"
* #cuidado-compartilhado "Cuidado compartilhado com outro profissional de saúde"