...
* ^meta.lastUpdated = "2025-07-17T17:30:08.808+00:00"
* ^version = "1.0.0"
* ^status = #active
* ^experimental = false
...
* ^caseSensitive = true
* ^content = #complete
* #ESR "Estabelecimento de saúde regulador"
* #ESE "Estabelecimento de saúde executante"
* #ESS "Estabelecimento de saúde solicitante"
* #PCT "Paciente"