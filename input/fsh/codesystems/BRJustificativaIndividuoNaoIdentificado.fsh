...
* ^meta.lastUpdated = "2025-07-17T17:37:00.949+00:00"
* ^version = "1.0.0"
* ^status = #active
* ^experimental = false
...
* ^caseSensitive = true
* ^content = #complete
* #99 "Sem registro no modelo de informação de origem"
* #3 "Indivíduo com problema neurológico grave ou comatoso"
* #2 "Indivíduo em sofrimento mental encontrado em via pública"
* #5 "Indivíduo doador de órgãos falecido"
* #4 "Indivíduo incapacitado por motivos sociais e/ou culturais"
* #1 "Indivíduo acidentado grave"