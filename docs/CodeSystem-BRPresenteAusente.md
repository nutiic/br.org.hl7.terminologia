...
## CodeSystem: BRPresenteAusente 

| | |
| :--- | :--- |
| *URL Canônica*:https://terminologia.saude.gov.br/fhir/CodeSystem/BRPresenteAusente | *Versão*:1.1.0 |
| Active as of 2026-09-01 | *Nome computável*:BRPresenteAusente |
...
```json
{
  ...
  "meta" : {
    "lastUpdated" : "2026-07-24T16:02:17.866Z"
  },
  "extension" : [{
    "url" : "http://fhir.org/FHIRsmith/StructureDefinition/ocl-codesystem",
    "valueBoolean" : true
  }],
  "url" : "https://terminologia.saude.gov.br/fhir/CodeSystem/BRPresenteAusente",
  "version" : "1.1.0",
  "name" : "BRPresenteAusente",
  "title" : "BRPresenteAusente",
  "status" : "active",
  "experimental" : false,
