...
## CodeSystem: BRHPVInterpretacao 

| | |
| :--- | :--- |
| *URL Canônica*:https://terminologia.saude.gov.br/fhir/CodeSystem/BRHPVInterpretacao | *Versão*:1.1.0 |
| Active as of 2026-09-01 | *Nome computável*:BRHPVInterpretacao |

 This Code system is referenced in the content logical definition of the following value sets: 

* [BRHPVInterpretacao](ValueSet-BRHPVInterpretacao.md)
...
```json
{
  ...
  "meta" : {
    "lastUpdated" : "2026-01-25T18:31:13.816Z"
  },
  "extension" : [{
    "url" : "http://fhir.org/FHIRsmith/StructureDefinition/ocl-codesystem",
    "valueBoolean" : true
  }],
  "url" : "https://terminologia.saude.gov.br/fhir/CodeSystem/BRHPVInterpretacao",
  "version" : "1.1.0",
