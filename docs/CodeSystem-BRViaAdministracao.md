...
| | |
| :--- | :--- |
| *URL Canônica*:https://terminologia.saude.gov.br/fhir/CodeSystem/BRViaAdministracao | *Versão*:1.1.0 |
| Active as of 2026-03-09 | *Nome computável*:BRViaAdministracao |

 This Code system is referenced in the content logical definition of the following value sets: 

* [BR Via Administracao](ValueSet-BRViaAdministracao.md)
...
```json
{
  ...
  "meta" : {
    "lastUpdated" : "2025-07-16T16:52:24.744+00:00"
  },
  "url" : "https://terminologia.saude.gov.br/fhir/CodeSystem/BRViaAdministracao",
  "version" : "1.1.0",
