# BR.GOV.SAUDE.TERMINOLOGIA.FHIR\BR Terminologia Suspeita Diagnostica - FHIR v4.0.1

* [**Table of Contents**](toc.md)
* [**Lista de artefatos**](artifacts.md)
* **BR Terminologia Suspeita Diagnostica**

## ValueSet: BR Terminologia Suspeita Diagnostica 

| | |
| :--- | :--- |
| *URL Canônica*:https://terminologia.saude.gov.br/fhir/ValueSet/BRTerminologiaSuspeitaDiagnostica | *Versão*:1.1.0 |
...
```json
{
  ...
  "url" : "https://terminologia.saude.gov.br/fhir/ValueSet/BRTerminologiaSuspeitaDiagnostica",
  "version" : "1.1.0",
  "name" : "BRTerminologiaSuspeitaDiagnostica",
  "title" : "BR Terminologia Suspeita Diagnostica",
  "status" : "active",
