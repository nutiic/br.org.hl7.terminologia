# BR.GOV.SAUDE.TERMINOLOGIA.FHIR\BR Carater Atendimento - FHIR v4.0.1

* [**Table of Contents**](toc.md)
* [**Lista de artefatos**](artifacts.md)
* **BR Carater Atendimento**

## ValueSet: BR Carater Atendimento 

| | |
| :--- | :--- |
| *URL Canônica*:https://terminologia.saude.gov.br/fhir/ValueSet/BRCaraterAtendimento | *Versão*:1.1.0 |
...
```json
{
  ...
  "compose" : {
    "include" : [{
      "system" : "https://terminologia.saude.gov.br/fhir/CodeSystem/BRCaraterAtendimento",
      "concept" : [{
        "code" : "99",
