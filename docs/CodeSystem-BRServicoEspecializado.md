# BR.GOV.SAUDE.TERMINOLOGIA.FHIR\BRServicoEspecializado - FHIR v4.0.1
...
| | |
| :--- | :--- |
| *URL Canônica*:https://terminologia.saude.gov.br/fhir/CodeSystem/BRServicoEspecializado | *Versão*:1.1.0 |
| Active as of 2026-03-09 | *Nome computável*:BRServicoEspecializado |

 This Code system is referenced in the content logical definition of the following value sets: 

* [BR Servico Especializado](ValueSet-BRServicoEspecializado.md)
...
```json
{
  ...
  "meta" : {
    "lastUpdated" : "2025-07-17T17:30:25.662+00:00"
  },
  "url" : "https://terminologia.saude.gov.br/fhir/CodeSystem/BRServicoEspecializado",
  "version" : "1.1.0",
