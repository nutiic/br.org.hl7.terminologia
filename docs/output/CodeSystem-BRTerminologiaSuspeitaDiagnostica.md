...
## CodeSystem: BRTerminologiaSuspeitaDiagnostica 

| | |
| :--- | :--- |
| *URL Canônica*:https://terminologia.saude.gov.br/fhir/CodeSystem/BRTerminologiaSuspeitaDiagnostica | *Versão*:1.1.0 |
| Active as of 2026-09-01 | *Nome computável*:BRTerminologiaSuspeitaDiagnostica |
...
```json
{
  ...
  "meta" : {
    "lastUpdated" : "2026-07-24T16:03:02.139Z"
  },
  "extension" : [{
    "url" : "http://fhir.org/FHIRsmith/StructureDefinition/ocl-codesystem",
    "valueBoolean" : true
  }],
  "url" : "https://terminologia.saude.gov.br/fhir/CodeSystem/BRTerminologiaSuspeitaDiagnostica",
  "version" : "1.1.0",
  "name" : "BRTerminologiaSuspeitaDiagnostica",
  "title" : "BRTerminologiaSuspeitaDiagnostica",
  "status" : "active",
  "experimental" : false,
