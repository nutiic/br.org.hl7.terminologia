...
## CodeSystem: BRTipoTeleconsultoria 

| | |
| :--- | :--- |
| *URL Canônica*:https://terminologia.saude.gov.br/CodeSystem/BRTipoTeleconsultoria | *Versão*:1.1.0 |
...
```json
{
  ...
  "meta" : {
    "lastUpdated" : "2026-06-10T13:54:45.375Z"
  },
  "extension" : [{
    "url" : "http://fhir.org/FHIRsmith/StructureDefinition/ocl-codesystem",
    "valueBoolean" : true
  }],
  "url" : "https://terminologia.saude.gov.br/CodeSystem/BRTipoTeleconsultoria",
  "version" : "1.1.0",
