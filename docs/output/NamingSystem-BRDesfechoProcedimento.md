...
## NamingSystem: BRDesfechoProcedimento 

| | |
| :--- | :--- |
| *URL Canônica*:https://terminologia.saude.gov.br/fhir/NamingSystem/BRDesfechoProcedimento | *Versão*:1.1.0 |
| Active as of 2026-03-09 | *Nome computável*:BRDesfechoProcedimento |

 
Desfecho Procedimento 
...
```json
{
  ...
  "extension" : [{
    ...
    "valueUri" : "https://terminologia.saude.gov.br/fhir/NamingSystem/BRDesfechoProcedimento"
  },
  {
  ...
  "uniqueId" : [{
    "type" : "uri",
    "value" : "http://www.saude.gov.br/fhir/r4/CodeSystem/BRDesfechoProcedimento",
    "preferred" : false
  },
  {
    "type" : "uri",
