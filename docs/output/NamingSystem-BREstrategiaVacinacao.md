...
## NamingSystem: BREstrategiaVacinacao 

| | |
| :--- | :--- |
| *URL Canônica*:https://terminologia.saude.gov.br/fhir/NamingSystem/BREstrategiaVacinacao | *Versão*:1.1.0 |
...
```json
{
  ...
  "extension" : [{
    ...
    "valueUri" : "https://terminologia.saude.gov.br/fhir/NamingSystem/BREstrategiaVacinacao"
  },
  {
  ...
  "uniqueId" : [{
    "type" : "uri",
    "value" : "http://www.saude.gov.br/fhir/r4/CodeSystem/BREstrategiaVacinacao",
    "preferred" : false
  },
  {
    "type" : "uri",
