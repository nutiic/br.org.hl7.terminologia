...
## NamingSystem: BRTabelaSUS 

| | |
| :--- | :--- |
| *URL Canônica*:https://terminologia.saude.gov.br/fhir/NamingSystem/BRTabelaSUS | *Versão*:1.1.0 |
...
```json
{
  ...
  "extension" : [{
    ...
    "valueUri" : "https://terminologia.saude.gov.br/fhir/NamingSystem/BRTabelaSUS"
  },
  {
  ...
  "uniqueId" : [{
    "type" : "uri",
    "value" : "http://www.saude.gov.br/fhir/r4/CodeSystem/BRTabelaSUS",
    "preferred" : false
  },
  {
    "type" : "uri",
