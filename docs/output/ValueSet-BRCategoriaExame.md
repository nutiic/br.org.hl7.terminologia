# BR.GOV.SAUDE.TERMINOLOGIA.FHIR\BR Categoria Exame - FHIR v4.0.1

* [**Table of Contents**](toc.md)
* [**Lista de artefatos**](artifacts.md)
* **BR Categoria Exame**

## ValueSet: BR Categoria Exame 

| | |
| :--- | :--- |
| *URL Canônica*:https://terminologia.saude.gov.br/fhir/ValueSet/BRCategoriaExame | *Versão*:1.1.0 |
| Active as of 2026-03-09 | *Nome computável*:BRCategoriaExame |
...
```json
{
  ...
  "id" : "BRCategoriaExame",
  "url" : "https://terminologia.saude.gov.br/fhir/ValueSet/BRCategoriaExame",
  "version" : "1.1.0",
