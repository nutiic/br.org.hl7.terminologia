...
## CodeSystem: BRTipoDeficiencia 

| | |
| :--- | :--- |
| *URL Canônica*:https://terminologia.saude.gov.br/fhir/CodeSystem/BRTipoDeficiencia | *Versão*:1.1.0 |
| Active as of 2026-09-01 | *Nome computável*:BRTipoDeficiencia |

 This Code system is referenced in the content logical definition of the following value sets: 

* [BRTipoDeficiencia](ValueSet-BRTipoDeficiencia.md)
...
```json
{
  ...
  "meta" : {
    "lastUpdated" : "2026-03-16T13:19:34.719Z"
  },
  "extension" : [{
    "url" : "http://fhir.org/FHIRsmith/StructureDefinition/ocl-codesystem",
    "valueBoolean" : true
  }],
  "url" : "https://terminologia.saude.gov.br/fhir/CodeSystem/BRTipoDeficiencia",
  "version" : "1.1.0",
